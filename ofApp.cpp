...
void ofApp::update() {
	...
	float r = ofGetFrameNum() % 60 < 30 ? ofMap(ofGetFrameNum() % 60, 0, 30, R * 0.1, R * 0.5) : ofMap(ofGetFrameNum() % 60, 30, 60, R * 0.5, R * 0.1);
	...
	r = ofGetFrameNum() % 60 < 30 ? ofMap(ofGetFrameNum() % 60, 0, 30, R * 0.5, R * 0.1) : ofMap(ofGetFrameNum() % 60, 30, 60, R * 0.1, R * 0.5);

	face_color = ofColor(0);
	line_color = ofColor(255);
